...
class FacetedSearch {
    ...
    bindEvents() {
        ...
        hooks.on('sortBy-select-changed', this.onSortBySelectChanged); // papathemes-supermarket
    }
    ...
    unbindEvents() {
        ...
        hooks.off('sortBy-select-changed', this.onSortBySelectChanged); // papathemes-supermarket
    }
    ...
    onSortBySelectChanged(event, currentTarget) {
