...
import { disableBodyScroll, enableBodyScroll } from 'body-scroll-lock'; // Chiara - enable/disable body scroll on iOS
...
export class MobileMenuToggle {
    ...
    bindEvents() {
        ...
        // Chiara: close when [data-group-collapsible] open
        $('[data-group-collapsible]').on(CollapsibleEvents.open, this.onGroupCollapsibleOpen);
    ...
    unbindEvents() {
        ...
        // Chiara MOD
        $('[data-group-collapsible]').off(CollapsibleEvents.open, this.onGroupCollapsibleOpen);
    ...
    show() {
        ...
        disableBodyScroll(this.$scrollView.get(0)); // Chiara - disable body scroll on iOS

        // Chiara: Collapse all [data-group-collapsible]
        $('[data-group-collapsible]').each((i, el) => {
            const collapsible = $(el).data('collapsibleInstance');
    ...
    hide() {
        ...
        enableBodyScroll(this.$scrollView.get(0)); // Chiara - enable body scroll on iOS
